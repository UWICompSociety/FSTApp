...
public class RestImage {
    ...
    public RestImage(String url) {
            this.url = url; //url to connect to rest api eg.localhost/api/images
    }
    ...
    public ArrayList<ImageItem> getImages() {
        ...
        try{
            ...
            imageItems = gson.fromJson(reader, new TypeToken<List<ImageItem>>(){}.getType());
