...
import com.uwimonacs.fstmobile.models.locations.Building;
...
public class Path {
    ...
    public static List<Vertex> connectedNodes;
    ...
    public static Path getInstance(DbHelper dbHelper){
        if(instance==null){
            instance = new Path(dbHelper);
        }
        return instance;
    }
           ...
           case "building":
               ...
               if(res.getCount() == 0){
                ...
                Location = new Building(
                        ...
                        res.getString(res.getColumnIndex(AppDbHelper.B_ROOMS)),
